...
#define STDX_TIME_VERSION_MAJOR 1
#define STDX_TIME_VERSION_MINOR 0
#define STDX_TIME_VERSION_PATCH 0

#define STDX_TIME_VERSION (STDX_TIME_VERSION_MAJOR * 10000 + STDX_TIME_VERSION_MINOR * 100 + STDX_TIME_VERSION_PATCH)
...
#  include <unistd.h>
  ...
  XTime   x_time_add(XTime a, XTime b); // Arithmetic
